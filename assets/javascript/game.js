 ...
 */ 
     ...
     function UpdateHangedMan()
     {
        if(remaining+earned >= 6)
          document.querySelector("#gallows").innerHTML = "<img src=\"assets/images/HangmanStart.png\" class=\"img-responsive center-block\ alt = \"Empty gallows\">";
        else if(remaining+earned == 5)
          document.querySelector("#gallows").innerHTML = "<img src=\"assets/images/HangmanOne.png\" class=\"img-responsive center-block\ alt = \"Gallows with head\">";
        else if(remaining+earned == 4)
          document.querySelector("#gallows").innerHTML = "<img src=\"assets/images/HangmanTwo.png\" class=\"img-responsive center-block\ alt = \"Gallows with head and body\">";
        else if(remaining+earned == 3)
          document.querySelector("#gallows").innerHTML = "<img src=\"assets/images/HangmanThree.png\" class=\"img-responsive center-block alt = \"Gallows with head, body, and one arm\">";
        else if(remaining+earned == 2)
          document.querySelector("#gallows").innerHTML = "<img src=\"assets/images/HangmanFour.png\" class=\"img-responsive center-block alt = \"Gallows with head, body, and both arms\">";
        else if(remaining+earned == 1)
          document.querySelector("#gallows").innerHTML = "<img src=\"assets/images/HangmanFive.png\" class=\"img-responsive center-block alt = \"Gallows with head, body, arms, and one leg\">";
        else
          document.querySelector("#gallows").innerHTML = "<img src=\"assets/images/HangmanFinished.png\" class=\"img-responsive center-block alt = \"Full gallows\">";
